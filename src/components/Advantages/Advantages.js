...
const Advantages = () => {
  ...
  const advatagesList = [
    ...
    {
      text: 'Организовывай и участвуй в мастер-классах, семинарах, презинтациях, нетворкингах для собственного роста и развития индустрии красоты города.',
      cls: 'Advantages__4'
    },
    {
  ...
  return (
    <section className={classes.Advantages}>
      <WithWrapper>
        ...
        <p id='Price'>Видишь, с нами удобно и выгодно!</p>
      </WithWrapper>
    </section>
  );
}
